...
class WordPress_Plugin_Template_Settings {
	...
	public function configure_settings( $settings = array() ) {
		...
		//$settings['parent_slug'] = 'edit.php?post_type=ctp';
		return $settings;
	}
	 ...
	 * Build settings fields
	 *
	 * @return html Fields to be displayed on settings
	 */
	...
	/**
	 * Build settings field for section
	 *
	 * @return html Field to be displayed on settings section
	 */
	...
	public function settings_page() {
		...
		$html      = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2 style="display: none;">' . __( 'Plugin Settings', 'wordpress-plugin-template' ) . '</h2>' . "\n";
			$html .= '<div class="lbr-wrapper theme-alt">
				  		<div class="lbr-header">
				  			<div class="lbr-title">
							    <!-- Print the page title -->
							    <h1>' . __( $this->parent->_name, 'wordpress-plugin-template' ) . '</h1>
								'.$this->parent->_description.'			    
								<!-- Here are our tabs -->
							</div>
							<div class="lbr-version">
								<img src="'.$this->parent->assets_url.'img/lbrlogo.png">
								<span>Version '.$this->parent->_version.'</span>
							</div>
					    </div>';
			$tab = '';
		//phpcs:disable
		...
		if ( is_array( $this->settings ) && 1 < count( $this->settings ) ) {
			...
			$html .= '<div class="lbr-toolbar"><nav class="nav-tab-wrapper">' . "\n";
			...
			$html .= '<div class="tab-content"><form method="post" action="options.php" enctype="multipart/form-data"><div class="lbr-body">' . "\n";
				...
				$html     .= '</div><div class="lbr-footer"><p class="submit">' . "\n";
					$html .= '<input type="hidden" name="tab" value="' . esc_attr( $tab ) . '" />' . "\n";
					$html .= '<input name="Submit" type="submit" class="lbr-btn lbr-btn-primary" value="' . esc_attr( __( 'Save Settings', 'wordpress-plugin-template' ) ) . '" />' . "\n";
				$html     .= '</p></div>' . "\n";
			$html         .= '</form></div>' . "\n";
		$html             .= '</div></div>' . "\n";
